    ...
    <div ref={containerRef} className="max-w-full" style={{ height: '3000px' }}>
      ...
      >
        ...
        <div className="pt-80 px-4">
          {/* Button - sticky at 8px from top (very close to banner) */}
          <div className="sticky top-2 bg-white z-20 py-4 flex justify-center">
            <Link 
              to="/blog" 
          ...
          <div className="max-w-4xl mx-auto pb-16 relative z-10 pt-4">
